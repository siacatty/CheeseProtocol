...
public class Dialog_BeginLesson : Dialog_BeginLordJob
{
    ...
    private Dialog_BeginLesson(RitualRoleAssignments assignments, Precept_Ritual ritual, TargetInfo target, RitualOutcomeEffectDef outcome)
