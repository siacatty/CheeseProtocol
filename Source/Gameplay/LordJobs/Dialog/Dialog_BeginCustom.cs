...
{
    public class Dialog_BeginCustom : Dialog_BeginLordJob
    {
        ...
        protected override IEnumerable<string> BlockingIssues()
        {
            ...
            if (maxParticipants > 0 && assignments.Participants.Count > maxParticipants)
            {
                yield return $"최대 {maxParticipants}명 까지만 참여 가능합니다.";
            }
        ...
        private Dialog_BeginCustom(RitualRoleAssignments assignments, Precept_Ritual ritual, TargetInfo target, RitualOutcomeEffectDef outcome)
        ...
        public Dialog_BeginCustom(string ritualLabel, Precept_Ritual ritual, TargetInfo target, Map map, ActionCallback action, Pawn organizer, RitualObligation obligation, PawnFilter filter = null, string okButtonText = null, List<Pawn> requiredPawns = null, Dictionary<string, Pawn> forcedForRole = null, RitualOutcomeEffectDef outcome = null, List<string> extraInfoText = null, Pawn selectedPawn = null, int maxParticipants = 0)
