...
// RimWorld.LordJob_BestowingCeremony
using System;
...
public class LordJob_temp : LordJob_Ritual
{
	...
	public LordJob_temp(Pawn bestower, Pawn target, LocalTargetInfo targetSpot, IntVec3 spotCell, Thing shuttle = null, string questEndedSignal = null)
	{
